...
2. **父元素没有定位**，则以**浏览器**为准定位（Document 文档）。
   ...
   <img src="./img/05_绝对定位_父级无定位.png" width="600" />

3. **父元素要有定位**

    * 元素将依据最近的已经定位（绝对、固定或相对定位）的父元素（祖先）进行定位。

<img src="./img/06_绝对定位_父级有定位.png" width="600" />
...
![子绝父相截图](./img/07_子绝父相截图.png)

<img src='./img/27子绝父相.png'>
...
![1571385860679](img/1571385860679.png)
...
<img src='img/1571388901848.png' width='350'>



<img src='img/1571389108805.png' width='300'>



案例效果：

![1571389241926](img/1571389241926.png)
...
<img src='img/文字环绕图片.png'>

## 5. 综合案例 - 淘宝轮播图(重点)

### 5.1 效果图

<img src='img/淘宝焦点图.png' width='600'>

### 5.2 布局分析

![1571397019689](img/1571397019689.png)
